...
from player import guess, speak, vote
...
def test_player(roles, rounds):
    ...
    list_words = [
        str(word)
        for word in np.random.choice(words, size=len(rounds) * n_players, replace=False)
    ]
    list_players = []
    known_roles = dict()
...
print(
    "If no message appears, your player passes the test. Otherwise, please modify your code."
)
